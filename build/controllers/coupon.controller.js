...
exports.createCoupon = exports.checkCoupon = exports.getAllCoupons = void 0;
...
exports.checkCoupon = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const getAllCouponData = await coupon_models_1.default.find().sort({ createdAt: -1 }).select('couponCode status');
        res.status(200).json({
            success: true,
...
exports.createCoupon = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        // }
        await coupon_models_1.default.create({
